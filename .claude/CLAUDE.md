...
The workspace `/home/lab/workspace/.claude/` directory contains additional instruction files and
skills (mermaid-diagrams, notebook-standards, git, my-repository, jupyterlab-extension, and others)
referenced by CLAUDE.md. Consult workspace CLAUDE.md and the .claude directory to discover all
